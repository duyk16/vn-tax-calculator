...
- Sửa lỗi/tính năng nhỏ: tạo một pull request (PR) kèm mô tả ngắn gọn về thay đổi.
- Quy trình đề xuất:
  1. Fork repository này
  2. Tạo nhánh mới từ `main` (ví dụ: `feat/ten-tinh-nang` hoặc `fix/ten-loi`)
  3. Commit nhỏ gọn, thông điệp rõ ràng
  4. Mở PR và liên kết tới issue (nếu có)
